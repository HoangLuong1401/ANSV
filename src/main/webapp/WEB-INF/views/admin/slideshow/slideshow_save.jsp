            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="header">
                        <div class="col-md-8">
                            <h3 class="title">
                                Admin: <b>Adding Slideshow</b>
                            </h3>
                            <p class="category">Chèn thêm nội dung trong phần trình diễn slide</p>
                        </div>
                        <div class="col-md-4">
                            <a href="<c:url value='/admin/web/quan-ly/slideshow' />" style="float: right;">
                    ...
                    <div class="content">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <c:url value="/admin/web/quan-ly/saveSlideshow?${_csrf.parameterName}=${_csrf.token}" var="saveSlideshow" />
                                <form:form action="${saveSlideshow}" method="POST" modelAttribute="slideshow" enctype="multipart/form-data">
