                                    ...
                                    <div id="owl-demo" class="owl-carousel owl-theme">
                                        ...
                                        <c:forEach var="item_news" items="${news}" varStatus="index">
                                            ...
                                            <div class="item">
                                                <div class="post-module">
                                                    <div class="thumbnail">
                                                        <img
                                                                src="<c:url value='/assets/user/img/news/${item_news.img}' />" style="width: 390px;">
                                                    </div>
                                                    <div class="post-content">
                                        ...
                                        <div class="item">
                                            <div class="post-module">
                                                <div class="thumbnail">
                                                    <img
                                                            src="<c:url value='/assets/user/img/news/demo.png' />">
                                                </div>
                                                <div class="post-content">
                                                    <div class="post-content-child-news">
                                                        <img
                                                        ...
                                                        <h1 class="title"></h1>
                                                        <h2 class="sub_title_2 title-bold">
                                                            <div class="p-n-title">demo</div>
                                                        </h2>
                                                        <div class="description">
                                                            <div class="p-n-content">demo</div>
                                                        </div>
                                                        <div class="post-meta" align="right">
																	<span class="comments"> <a
                                                                            href="#">Xem thêm...</a>
